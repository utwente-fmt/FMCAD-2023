...
from examples.robot_bad.robot import Robot as RobotBad
from examples.robot_1MS.robot import Robot as Robot1MS
from examples.robot_6MS.robot import Robot as Robot6MS
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        if sys.argv[1] == "robot":
            ...
            p = RobotDummy()
        elif sys.argv[1] == "robot-bad-proc":
            p = RobotBad()
        elif sys.argv[1] == "robot-1MS":
            p = Robot1MS()
        elif sys.argv[1] == "robot-6MS":
            p = Robot6MS()
            ...
            print("Options are: robot, robot-dummy, robot-bad-proc, robot-1MS, robot-6MS, prod-cons, abs-asr")
            exit(0)
